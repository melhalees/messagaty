...
abstract class AppColors {
  ...
  static const cardDark = Color(0xFF202425);
}
...
class AppTheme {
  ...
  ThemeData get light => ThemeData(
    ...
    textTheme:
    GoogleFonts.montserratTextTheme().apply(bodyColor: AppColors.textDark),
  ...
  ThemeData get dark => ThemeData(
    ...
    visualDensity: visualDensity,
    textTheme:
    GoogleFonts.montserratTextTheme().apply(bodyColor: AppColors.textLight),
